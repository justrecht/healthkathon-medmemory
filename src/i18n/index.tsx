...
const translations: Translations = {
  id: {
    ...
    haveTakenMedication: "Apakah sudah minum obat?",
    yes: "Ya",
    upcomingMedication: "Obat Segera",
    medicationIn30Minutes: "Obat akan diminum dalam 30 menit",
  ...
  en: {
    ...
    haveTakenMedication: "Have you taken your medication?",
    yes: "Yes",
    upcomingMedication: "Upcoming Medication",
    medicationIn30Minutes: "Medication in 30 minutes",
